...
public class InMemoryMovieService implements MovieService {
	@Inject // declares dependency -> Container: DI (Dependency Injection)
	private SequenceService sequenceSrv; //loose coupled, 
	...
	@Override
	@Produces
	@Named("genres") // JSP Expression Language: ${genres}
	@Singleton
